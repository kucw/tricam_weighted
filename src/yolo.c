...
//char *voc_names[] = {"car","DoNotEnter","speed50","speed60"};
...
void train_yolo(char *cfgfile, char *weightfile)
{
    ...
    char *train_images = "/home/newslab/jeff/darknet-video-2class/mytrain_morecar.txt";

    /* Change output weight folders here */
    char *backup_directory = "/home/newslab/jeff/yolo_weight";
    srand(time(0));
    data_seed = time(0);
...
void test_yolo(char *cfgfile, char *weightfile, char *filename, float thresh)
{
    ...
    while(1){
        ...
        draw_detections(im, l.side*l.side*l.n, thresh, boxes, probs, voc_names, voc_labels, CLASSNUM,0);
...
void demo_yolo(char *cfgfile, char *weightfile, float thresh, int cam_index, char* filename, char* version);
#ifndef GPU
void demo_yolo(char *cfgfile, char *weightfile, float thresh, int cam_index, char* filename, char* version)
{
...
void run_yolo(int argc, char **argv)
{
	...
	char *version = (argc > 6) ? argv[6] : 0;
    if(0==strcmp(argv[2], "test")) test_yolo(cfg, weights, filename, thresh);
    else if(0==strcmp(argv[2], "train")) train_yolo(cfg, weights);
    else if(0==strcmp(argv[2], "valid")) validate_yolo(cfg, weights);
    else if(0==strcmp(argv[2], "recall")) validate_yolo_recall(cfg, weights);
    else if(0==strcmp(argv[2], "demo_cam")) demo_yolo(cfg, weights, thresh, cam_index, "NULL", version);
    else if(0==strcmp(argv[2], "demo_vid")) demo_yolo(cfg, weights, thresh, -1, filename, version);
}
